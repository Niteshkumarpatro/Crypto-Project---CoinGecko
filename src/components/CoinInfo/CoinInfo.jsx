...
import { chartDays } from "../../helpers/constansts";
        ...
        <>
            <div className="flex flex-col items-center justify-center mt-6 p-6 w-full ">
                ...
                <div className="flex justify-center mt-5 w-full">
                    <select defaultValue="Pick a text editor" className="select select-primary" onChange={handleDayChange}>
                        {chartDays.map((day, index) => {
                            return (
                                <option selected={days == day.value} key={index} value={day.value} onClick={handleDayChange}>{day.label}</option>
                            )
                        })}
